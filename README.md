...
A multi-agent financial research assistant built with [phidata](https://github.com/agno-agi/phidata) (now Agno) and [Groq](https://groq.com), with a Streamlit chat UI.

The system uses a **team of AI agents**:

- **Financial Analyst** — fetches live stock price, fundamentals, and analyst recommendations via [yfinance](https://pypi.org/project/yfinance/)
